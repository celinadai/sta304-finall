...
author: 
  - Shengyi Dai
thanks: "Code and data are available at: https://github.com/celinadai/STA304-FINAL.git"
...
library(ggplot2)
library(caret)
reduced_data <- read.csv("/home/jovyan/1STA304/STA304-FINAL/outputs/data/reduced_data.csv")
```
...
In the [Graph: \@ref(fig:tim)], it is obvious that the cases of robbery is more likely to happen in the afternoon and night. The streets and apartments have a higher chance to get robbed at night. For other commercial place, pharmacy, and streets have a high chance of robbery occurs in afternoon. The [Graph: \@ref(fig:oc)] is a graph about the count of offence with occurrence days of the month filled in. The days of the month had been separted into beginning, middle, or end of the month. 
...
```{r day, echo=FALSE}
summary_table <- reduced_data %>% summarise(
    min = min(occurrencehour),
    Q1 = quantile(occurrencehour,0.25),
    median = median(occurrencehour),
    Q3 = quantile(occurrencehour,0.75),
